...
const Sidebar = ({ collapsed, setCollapsed }: SidebarProps) => {
  ...
  return (
    <div className="relative h-screen w-full">
      <aside
        className={clsx(
      'fixed top-0 left-0 h-full bg-[#132A21] text-pink-100 shadow-lg flex flex-col justify-between items-center transition-all duration-300 z-50',
      ...
      >
        ...
        {/* Logout Button */}
        <div className="p-4">
          <div className="flex items-center  w-[234px] h-[36px] p-[8px] rounded-md gap-[12px] justify-center cursor-pointer border-[0.5px] border-[#fff]/10 hover:bg-red-100 transition">
            <Image src="/img/login.png" alt="Logout" width={20} height={20} />
            {!collapsed && <span className="ml-3 text-[#FFCDCD] font-medium leading-[100%] w-[80px] h-[18px] font-sora text-[14px]">Log Out</span>}
          </div>
        </div>
      </aside>
    </div>
